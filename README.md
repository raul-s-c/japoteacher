...
Continuación: se añaden otras 32 parejas (64 ejercicios); total de la tanda: 52 parejas publicadas y tres pendientes de reparación. Consumo acumulado registrado: 339.606 tokens de los 1.500.000 autorizados, con posible consumo no informado de solicitudes desconectadas. El transporte volvió a fallar y la monitorización de Wrangler también perdió conexión; causa sin determinar. Banco activo actual: 2.280 parejas / 4.560 ejercicios. Listado de la continuación: `data/editorial/new-phrases-2026-09-04-continuation.md`.
...
La cobertura se cuenta por frase semántica única, no dos veces por existir en ambas direcciones. El vocabulario escrito solo en kana también puede ser objetivo. Las coincidencias de kana y las estructuras gramaticales requieren tags editoriales exactos; nunca se infieren por una subcadena (`いく` dentro de `いくら`, `さい` dentro de `ください` o `ないで` dentro de `ないです`). Las formas flexionadas se validan mediante su lema editorial y las lecturas kanji/okurigana. Tras publicar cada tanda se ejecuta de nuevo la clasificación completa antes de las auditorías.
