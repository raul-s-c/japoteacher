(function(){
  ...
  async function snapshot(){
    ...
    for(const attempt of attempts){const direction=dirs[attempt.direction];if(!direction)continue;direction.count++;direction.total+=attempt.overall_score||0;if(attempt.is_acceptable)direction.acceptable++}
    ...
    return {attempts:attempts.sort((a,b)=>b.attempted_at.localeCompare(a.attempted_at)),progress,exercises,eMap,dirs,tags,tagGroups:groupTags(tags),completedDays};
  }
